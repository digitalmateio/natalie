...
class CreateSpaconceptpartnersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Spaconceptpartners", 'spaconceptpartners', 'title_ge', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('spaconceptpartners')) {
            Schema::drop('spaconceptpartners');
        }
    }
}
