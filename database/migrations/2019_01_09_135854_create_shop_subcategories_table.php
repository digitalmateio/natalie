...
class CreateShopSubcategoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Shop_subcategories", 'shop_subcategories', 'title_ge', 'fa-cube', [
            ...
            ["parent_category", "parent category", "Dropdown", false, "", 0, 0, false, "@shop_categories"],
        ]);
    ...
    {
        if (Schema::hasTable('shop_subcategories')) {
            Schema::drop('shop_subcategories');
        }
    }
}
