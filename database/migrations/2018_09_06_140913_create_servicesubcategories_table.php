...
class CreateServicesubcategoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Servicesubcategories", 'servicesubcategories', 'title_ge', 'fa-sitemap', [
            ["parent_category_id", "Parent Category id", "Dropdown", false, "", 0, 0, false, "@servicecategories"],
    ...
    {
        if (Schema::hasTable('servicesubcategories')) {
            Schema::drop('servicesubcategories');
        }
    }
}
