...
class CreateSiteCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Site_categories", 'site_categories', 'title_ge', 'fa-cube', [
            ["title_ge", "Title ge", "String", false, "", 0, 50, false],
            ["title_en", "Title en", "String", false, "", 0, 50, false],
            ["title_ru", "Title ru", "String", false, "", 0, 50, false],
        ]);
