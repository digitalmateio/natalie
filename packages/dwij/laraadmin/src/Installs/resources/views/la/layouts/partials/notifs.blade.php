							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="@if(isset(Auth::user()->email)) {{url('/la-assets/img/avatar.png')}} @else asset('/img/user2-160x160.jpg' @endif" class="img-circle" alt="User Image"/>
										</div>
				...
				@else
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{url('/la-assets/img/avatar.png')}}" class="user-image" alt="User Image"/>
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="{{url('/la-assets/img/avatar.png')}}" class="img-circle" alt="User Image" />
								<p>
									{{ Auth::user()->name }}
									<?php
