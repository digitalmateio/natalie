...
class LAInstall extends Command
{
	...
	var $modelsInstalled = ["User", "Role", "Permission", "Employee", "Department", "Upload", "Backup"];
	...
	public function handle()
	{
		try {
			...
			$from = base_path('packages/dwij/laraadmin/src/Installs');
			$to = base_path();
			...
			if ($this->confirm("This process may change/append to the following of your existing project files:"
				...
				$this->copyFile($from."/config/file_config.php", $to."/config/file_config.php");
