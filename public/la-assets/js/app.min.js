...
$(document).ready(function() {
    ...
    function getLI(upload) {
        ...
        return '<li><a class="fm_file_sel" data-placement="top" title="'+upload.name+'" upload=\''+JSON.stringify(upload)+'\'>'+image+'</a></li>';
    }
    ...
    $(document).on("click", ".uploaded_file2 i.fa.fa-times", function(e){
    ...
    */
    $("body").on("click", ".fm_file_sel", function(e) {
        ...
        if(type == "image") {
            ...
            if(upload.extension == "jpg" || upload.extension == "png" || upload.extension == "gif" || upload.extension == "jpeg") {
                ...
                $hinput.next("a").next(".uploaded_image").children("img").attr("src", upload.thumbnails[Object.keys(upload.thumbnails)[0]]);
        } else {
            ...
            $hinput.next("a").next(".uploaded_file").attr("href", upload.thumbnails[Object.keys(upload.thumbnails)[0]]);
        } else if(type == "files") {
            $hinput = $("input[name="+$("#image_selecter_origin").val()+"]");
            ...
            var fileImage = "";
            if(upload.extension == "jpg" || upload.extension == "png" || upload.extension == "gif" || upload.extension == "jpeg") {
                fileImage = "<img src='"+upload.thumbnails[Object.keys(upload.thumbnails)[0]]+"'>";
            } else {
                fileImage = "<i class='fa fa-file-o'></i>";
            }
           
            $hinput.next("div.uploaded_files").append("<a class='uploaded_file2' upload_id='"+upload.id+"' target='_blank' href='"+upload.thumbnails[Object.keys(upload.thumbnails)[0]]+"'>"+fileImage+"<i title='Remove File' class='fa fa-times'></i></a>");
         
            /*
            $hinput.next("div.uploaded_files").append("<a class='uploaded_file2' upload_id='"+upload.id+"' >"+fileImage+"<i title='Remove File' class='rmInsertedImg fa fa-times'></i></a>");
            */
        }
        $("#fm").modal('hide');
    });
